...
| cq-4 |What are the properties describing a specific equipment? | the properties  of a specific battery includig the nominal charge voltage|
| cq-5 |What are the systems of a specific system kind, e.g Lithium battery? |the systems of interest that have a system kind the lithium battery model|
...
| iq-2 | What are the systems having a specific system configuration?| the list of batteries having the same properties with corresponding values|
